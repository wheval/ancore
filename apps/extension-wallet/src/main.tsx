  ...
  return (
    <div className="w-[360px] min-h-screen bg-background mx-auto shadow-xl flex flex-col items-center p-6 gap-4">
      ...
      <div className="flex gap-2 mb-4">
        <button onClick={() => setView('receive')} className="text-xs underline text-slate-500 hover:text-slate-900">
          Receive
        </button>
        <button onClick={() => setView('settings')} className="text-xs underline text-slate-500 hover:text-slate-900">
          Settings
        </button>
      </div>
