...
export const SendForm: React.FC = () => (
  <form className="flex flex-col gap-6 p-4">
    <div className="space-y-4">
      <label className="text-[11px] uppercase tracking-widest text-slate-500 font-bold">Recipient Address</label>
      <input 
        placeholder="G..." 
    ...
    <div className="space-y-4">
        <label className="text-[11px] uppercase tracking-widest text-slate-500 font-bold">Amount XLM</label>
        <div className="relative">
            <input 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white focus:border-cyan-400 focus:outline-none transition-all placeholder:text-slate-600" 
            />
            <button className="absolute right-4 top-1/2 -translate-y-1/2 text-cyan-400 font-bold text-xs uppercase tracking-widest px-2 py-1 rounded bg-cyan-400/10">MAX</button>
        </div>
    </div>
...
export const Review: React.FC = () => (
  <div className="flex flex-col gap-8 p-6 bg-slate-900 shadow-2xl rounded-3xl border border-white/10">
    <h2 className="text-xl font-bold text-white uppercase tracking-widest text-center">Confirm Send</h2>
...
export const Status: React.FC = () => (
    <div className="flex flex-col items-center justify-center p-12 text-center h-[300px]">
        ...
        <h2 className="text-2xl font-black text-white mb-2 uppercase tracking-widest">Sent Successfully</h2>
